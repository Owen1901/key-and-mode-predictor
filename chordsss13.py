...
def main():
    ...
    while True:
        ...
        # Plot normalized probabilities as a sorted bar chart (grouped by parent major scale)
        ...
        # Map each label to the parent-major color
        colors = []
        for lab in labels:
            parent = parent_major_of(lab)
            if parent is None:
                colors.append("#888888")  # fallback gray
            else:
                colors.append(parent_color[parent])

        # Create figure sized to number of bars
