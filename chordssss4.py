...
QUALITIES = ["major", "minor", "6", "minor6", "dominant7", "major7", "minor7", "dominant9", "major9", "minor9", "add9", "madd9"]
...
def degree_name(interval, upper_interval, bass_interval, quality, mode):
    ...
    if mode == "mixolydian":
        ...
        if upper_interval == 10 and bass_interval == 0 and quality == "major": return "I11"
